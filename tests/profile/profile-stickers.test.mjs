...
const profileSource = readFileSync(new URL('../../src/js/pages/profile/profileLegacy.js', import.meta.url), 'utf8');
const stickersSource = readFileSync(new URL('../../src/js/pages/profile/stickersLegacy.js', import.meta.url), 'utf8');
