...
Команда `/music` або `/shazam` переводить приватний чат у режим пошуку музики. Після цього потрібно ввести назву пісні або виконавця — Worker покаже до п’яти можливих варіантів для вибору. Відео, TikTok-посилання та окремі аудіофайли в цьому режимі не обробляються. Після вибору бот може надіслати доступне коротке офіційне preview та посилання на повну версію в легальному музичному сервісі, але не повну чужу пісню як файл без дозволу правовласника.
...
# Музичний пошук працює через публічні каталоги iTunes і Deezer; окремий ключ не потрібен
