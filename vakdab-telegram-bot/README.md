...
Популярні аніме та розклад залишаються окремими anime-only flows. Для аніме доступна кнопка **«Дивитись на VakDab»**, а для манґи й ранобе бот показує деталі та постер із посиланням на Hikka, якщо Telegram не може відкрити внутрішні деталі. Розклад надсилається як **одна вертикальна PNG-картка**: наданий банер розташовується згори, а актуальний список усіх днів від понеділка до неділі — нижче. Технічна назва джерела даних користувачу не показується.
