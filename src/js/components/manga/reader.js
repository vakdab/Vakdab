import { DEFAULT_CHAPTER_URL, getChapterFrames, getReaderBackgroundData, pageImageFallbackUrl, pageImageUrl, parseChapterUrl, saveMangaReadingProgress, getMangaReadingProgress } from '../../services/api/manga.js?v=20260824-settings-redesign-v1';
...
function renderShell(container, ids, pages, background, chapterUrl, onNavigate, mangaTitle = '') {
    ...
    // Check if there was saved reading progress for this title and chapter
