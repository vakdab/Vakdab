...
import { PROFILE_STICKER_SLOTS, getDefaultStickers, showToast, showToastProgress, escapeHtml, removeStickerBackground } from '../../legacy/app-legacy.js?v=20260821-one-all-instant-v7';
import { uploadBlobToCloudinary } from './homeLegacy.js?v=20260821-one-all-instant-v7';
