...
import { PROFILE_STICKER_SLOTS, getDefaultStickers, showToast, showToastProgress, escapeHtml, removeStickerBackground } from '../../legacy/app-legacy.js?v=20260821-ranobe-no-all-age-black-v11';
import { uploadBlobToCloudinary } from './homeLegacy.js?v=20260821-ranobe-no-all-age-black-v11';
