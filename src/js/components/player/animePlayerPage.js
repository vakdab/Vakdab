...
import { DailyStats } from '../rating/ratingSystem.js?v=20260821-all-only-v8';
import {
...
} from '../pages/homeLegacy.js?v=20260821-all-only-v8';
import { renderProfilePage } from '../pages/profileLegacy.js?v=20260821-all-only-v8';
import {
