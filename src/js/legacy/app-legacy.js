...
export const PROFILE_STICKER_SLOTS = 8;
        ...
        //  СИСТЕМА АВТОРИЗАЦІЇ
        // ====================================================================
import { Auth } from '../core/compat/auth.js?v=20260821-profile-thought-v27';
import { Storage } from '../core/compat/storage.js?v=20260821-profile-thought-v27';
import { Router } from '../core/compat/router.js?v=20260821-profile-thought-v27';
import { LampaPlayer } from '../components/player/lampaPlayer.js?v=20260820-player-modern-v1';
import { initCommunity } from '../components/community/legacyCommunity.js?v=20260821-profile-thought-v27';
...
import { renderFriendsPage, renderFollowingPage, renderProfilePage, renderPublicProfilePage } from '../components/pages/profileLegacy.js?v=20260821-profile-thought-v27';
import { calcTotalXP, getLevel, DailyStats, ACHIEVEMENTS, getUserRankInfo, initRatingPage, calculateBaseXP, getXPForLevel, getXPProgress, loadRatingPage, loadRatingList } from '../components/rating/ratingSystem.js?v=20260821-profile-thought-v27';
import {
    ...
    fetchTmdbCardInfo
} from '../components/player/animePlayerPage.js?v=20260821-profile-thought-v27';

import { getProfile, renderSettingsPage } from '../components/pages/settingsLegacy.js?v=20260821-profile-thought-v27';
import {
...
} from '../components/pages/homeLegacy.js?v=20260821-profile-thought-v27';
import {
...
} from '../services/catalog.js?v=20260821-profile-thought-v27';
