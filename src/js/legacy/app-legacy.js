...
import { PROXY_URL, CLOUDINARY_CLOUD_NAME, CLOUDINARY_UPLOAD_PRESET, HIKKA_API, HIKKA_PROXY_URL, MIKAI_BASE, GENRE_MAP } from '../config/constants.js?v=20260908-quality-1080-v1';
...
export const PROFILE_STICKER_SLOTS = 8;
        ...
        //  СИСТЕМА АВТОРИЗАЦІЇ
        // ====================================================================
import { Auth } from '../core/compat/auth.js?v=20260908-quality-1080-v1';
...
import { calcTotalXP, getLevel, getUserRankInfo, initRatingPage, calculateBaseXP, getXPForLevel, getXPProgress, loadRatingPage, loadRatingList } from '../components/rating/ratingSystem.js?v=20260908-rating-fix-v2';
import {
...
} from '../pages/player/animePlayerPage.js?v=20260908-quality-1080-v1';
...
export { calcTotalXP, getLevel, getUserRankInfo, initRatingPage, loadRatingPage, loadRatingList };
export {
    playerPageAnime, playerPageAnimeuaSeasons, externalSourceCache, playerPageCurrentSeason, playerPageCurrentDub, playerPageCurrentSource, playerPageIsOpen,
    setPlayerPageAnimeuaSeasons, setPlayerPageAnime, setPlayerPageCurrentSeason, setPlayerPageCurrentDub, setPlayerPageCurrentSource,
    openPlayerPage, closePlayerPage, buildSeasonRow, updateFilterChip, updateSourceChip, buildEpisodeViews,
