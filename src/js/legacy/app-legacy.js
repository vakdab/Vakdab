...
export const PROFILE_STICKER_SLOTS = 8;
        ...
        //  СИСТЕМА АВТОРИЗАЦІЇ
        // ====================================================================
import { Auth } from '../core/compat/auth.js?v=20260821-social-v7';
import { Storage } from '../core/compat/storage.js?v=20260821-social-v7';
import { Router } from '../core/compat/router.js?v=20260821-social-v7';
import { LampaPlayer } from '../components/player/lampaPlayer.js?v=20260820-player-modern-v1';
import { initCommunity } from '../components/community/legacyCommunity.js?v=20260821-social-v7';
...
import { renderProfilePage, renderPublicProfilePage } from '../components/pages/profileLegacy.js?v=20260821-social-v7';
import { calcTotalXP, getLevel, DailyStats, ACHIEVEMENTS, getUserRankInfo, initRatingPage, calculateBaseXP, getXPForLevel, getXPProgress, loadRatingPage, loadRatingList } from '../components/rating/ratingSystem.js?v=20260821-social-v7';
import {
...
import { getProfile, renderSettingsPage } from '../components/pages/settingsLegacy.js?v=20260821-social-v7';
import {
...
} from '../components/pages/homeLegacy.js?v=20260821-social-v7';
import {
