...
import { PROXY_URL, CLOUDINARY_CLOUD_NAME, CLOUDINARY_UPLOAD_PRESET, HIKKA_API, HIKKA_PROXY_URL, MIKAI_BASE, GENRE_MAP } from '../config/constants.js?v=20260909-player-v4';
...
export const PROFILE_STICKER_SLOTS = 8;
        ...
        //  СИСТЕМА АВТОРИЗАЦІЇ
        // ====================================================================
import { Auth } from '../core/compat/auth.js?v=20260909-player-v4';
...
} from '../pages/player/animePlayerPage.js?v=20260909-player-v4';
