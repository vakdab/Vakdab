...
export const PROFILE_STICKER_SLOTS = 8;
        ...
        //  СИСТЕМА АВТОРИЗАЦІЇ
        // ====================================================================
import { Auth } from '../core/compat/auth.js?v=20260821-profile-thought-v20';
...
import { initCommunity } from '../components/community/legacyCommunity.js?v=20260821-profile-thought-v20';
...
import { renderFriendsPage, renderFollowingPage, renderProfilePage, renderPublicProfilePage } from '../components/pages/profileLegacy.js?v=20260821-profile-thought-v20';
import { calcTotalXP, getLevel, DailyStats, ACHIEVEMENTS, getUserRankInfo, initRatingPage, calculateBaseXP, getXPForLevel, getXPProgress, loadRatingPage, loadRatingList } from '../components/rating/ratingSystem.js?v=20260821-profile-thought-v20';
import {
    ...
    fetchTmdbCardInfo
} from '../components/player/animePlayerPage.js?v=20260821-profile-thought-v20';

import { getProfile, renderSettingsPage } from '../components/pages/settingsLegacy.js?v=20260821-profile-thought-v20';
import {
...
} from '../components/pages/homeLegacy.js?v=20260821-profile-thought-v20';
import {
...
} from '../services/catalog.js?v=20260821-profile-thought-v20';
