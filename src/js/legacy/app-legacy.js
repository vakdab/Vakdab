...
import { initCommunity } from '../components/community/legacyCommunity.js?v=20260821-filter-cards-v4';
...
import { renderFriendsPage, renderFollowingPage, renderProfilePage, renderPublicProfilePage } from '../components/pages/profileLegacy.js?v=20260821-filter-cards-v4';
import { calcTotalXP, getLevel, DailyStats, ACHIEVEMENTS, getUserRankInfo, initRatingPage, calculateBaseXP, getXPForLevel, getXPProgress, loadRatingPage, loadRatingList } from '../components/rating/ratingSystem.js?v=20260821-filter-cards-v4';
import {
    ...
    fetchTmdbCardInfo
} from '../components/player/animePlayerPage.js?v=20260821-filter-cards-v4';

import { getProfile, renderSettingsPage } from '../components/pages/settingsLegacy.js?v=20260821-filter-cards-v4';
import {
...
} from '../components/pages/homeLegacy.js?v=20260821-filter-cards-v4';
import {
...
} from '../services/catalog.js?v=20260821-filter-cards-v4';
